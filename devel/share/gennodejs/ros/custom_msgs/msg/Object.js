...
class Object {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('s_pos')) {
        this.s_pos = initObj.s_pos
      }
      else {
        this.s_pos = 0.0;
      }
      if (initObj.hasOwnProperty('d_pos')) {
        this.d_pos = initObj.d_pos
      }
      else {
        this.d_pos = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [s_pos]
    bufferOffset = _serializer.float32(obj.s_pos, buffer, bufferOffset);
    // Serialize message field [d_pos]
    bufferOffset = _serializer.float32(obj.d_pos, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [s_pos]
    data.s_pos = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [d_pos]
    data.d_pos = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.s_pos !== undefined) {
      resolved.s_pos = msg.s_pos;
    }
    else {
      resolved.s_pos = 0.0
    }

    if (msg.d_pos !== undefined) {
      resolved.d_pos = msg.d_pos;
    }
    else {
      resolved.d_pos = 0.0
    }
