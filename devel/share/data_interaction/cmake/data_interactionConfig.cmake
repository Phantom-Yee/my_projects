...
if(data_interaction_CONFIG_INCLUDED)
  return()
endif()
set(data_interaction_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(data_interaction_SOURCE_PREFIX /home/ragen/ros_ws/CCPP_Server_7/src/data_interaction)
  set(data_interaction_DEVEL_PREFIX /home/ragen/ros_ws/CCPP_Server_7/devel)
  set(data_interaction_INSTALL_PREFIX "")
  set(data_interaction_PREFIX ${data_interaction_DEVEL_PREFIX})
else()
  set(data_interaction_SOURCE_PREFIX "")
  set(data_interaction_DEVEL_PREFIX "")
  set(data_interaction_INSTALL_PREFIX /home/ragen/ros_ws/CCPP_Server_7/install)
  set(data_interaction_PREFIX ${data_interaction_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'data_interaction' is deprecated")
...
set(data_interaction_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(data_interaction_INCLUDE_DIRS "")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND data_interaction_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND data_interaction_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ragen/ros_ws/CCPP_Server_7/devel/lib;/home/ragen/ros_ws/CCPP_Server_7/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(data_interaction_LIBRARY_DIRS ${lib_path})
      list(APPEND data_interaction_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'data_interaction'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND data_interaction_LIBRARIES ${lib})
    endif()
  endif()
...
set(data_interaction_EXPORTED_TARGETS "data_interaction_generate_messages_cpp;data_interaction_generate_messages_eus;data_interaction_generate_messages_lisp;data_interaction_generate_messages_nodejs;data_interaction_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${data_interaction_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;auto_msgs;sensor_msgs;gnss_gridmap")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 data_interaction_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${data_interaction_dep}_FOUND)
      find_package(${data_interaction_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${data_interaction_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(data_interaction_INCLUDE_DIRS ${${data_interaction_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(data_interaction_LIBRARIES ${data_interaction_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${data_interaction_dep}_LIBRARIES})
  _list_append_deduplicate(data_interaction_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(data_interaction_LIBRARIES ${data_interaction_LIBRARIES})

  _list_append_unique(data_interaction_LIBRARY_DIRS ${${data_interaction_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(data_interaction_EXPORTED_TARGETS ${${data_interaction_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "data_interaction-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${data_interaction_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
