...
(cl:defclass <LinktrackAnchorframe0> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector custom_msgs-msg:LinktrackTag)
   :initform (cl:make-array 0 :element-type 'custom_msgs-msg:LinktrackTag :initial-element (cl:make-instance 'custom_msgs-msg:LinktrackTag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackAnchorframe0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackAnchorframe0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<LinktrackAnchorframe0> is deprecated: use custom_msgs-msg:LinktrackAnchorframe0 instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackAnchorframe0>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'custom_msgs-msg:LinktrackTag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackAnchorframe0>)))
  ...
  "custom_msgs/LinktrackAnchorframe0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackAnchorframe0)))
  "Returns string type for a message object of type 'LinktrackAnchorframe0"
  "custom_msgs/LinktrackAnchorframe0")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackAnchorframe0>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackTag[] nodes~%~%~%================================================================================~%MSG: custom_msgs/LinktrackTag~%uint8 role~%uint8 id~%float32[3] pos_3d~%float32[8] dis_arr~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackAnchorframe0)))
  "Returns full string definition for message of type 'LinktrackAnchorframe0"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackTag[] nodes~%~%~%================================================================================~%MSG: custom_msgs/LinktrackTag~%uint8 role~%uint8 id~%float32[3] pos_3d~%float32[8] dis_arr~%~%~%"))
