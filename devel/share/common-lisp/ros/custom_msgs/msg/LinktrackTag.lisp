...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackTag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackTag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<LinktrackTag> is deprecated: use custom_msgs-msg:LinktrackTag instead.")))
