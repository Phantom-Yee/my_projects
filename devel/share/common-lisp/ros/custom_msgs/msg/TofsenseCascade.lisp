...
(cl:defclass <TofsenseCascade> (roslisp-msg-protocol:ros-message)
  ((nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector custom_msgs-msg:TofsenseFrame0)
   :initform (cl:make-array 0 :element-type 'custom_msgs-msg:TofsenseFrame0 :initial-element (cl:make-instance 'custom_msgs-msg:TofsenseFrame0))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TofsenseCascade>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TofsenseCascade)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<TofsenseCascade> is deprecated: use custom_msgs-msg:TofsenseCascade instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TofsenseCascade>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'custom_msgs-msg:TofsenseFrame0))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TofsenseCascade>)))
  ...
  (cl:format cl:nil "TofsenseFrame0[] nodes~%~%================================================================================~%MSG: custom_msgs/TofsenseFrame0~%uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TofsenseCascade)))
  "Returns full string definition for message of type 'TofsenseCascade"
  (cl:format cl:nil "TofsenseFrame0[] nodes~%~%================================================================================~%MSG: custom_msgs/TofsenseFrame0~%uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%~%~%"))
