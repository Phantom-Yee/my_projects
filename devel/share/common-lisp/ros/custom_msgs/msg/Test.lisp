...
(cl:defmethod cl:initialize-instance :after ((m <Test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<Test> is deprecated: use custom_msgs-msg:Test instead.")))
...
(cl:defmethod name-val ((m <Test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:name-val is deprecated.  Use custom_msgs-msg:name instead.")
  (name m))
