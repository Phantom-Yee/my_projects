...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackAoaNode0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackAoaNode0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<LinktrackAoaNode0> is deprecated: use custom_msgs-msg:LinktrackAoaNode0 instead.")))
...
(cl:defmethod fp_rssi-val ((m <LinktrackAoaNode0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:fp_rssi-val is deprecated.  Use custom_msgs-msg:fp_rssi instead.")
  (fp_rssi m))

(cl:ensure-generic-function 'rx_rssi-val :lambda-list '(m))
(cl:defmethod rx_rssi-val ((m <LinktrackAoaNode0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:rx_rssi-val is deprecated.  Use custom_msgs-msg:rx_rssi instead.")
  (rx_rssi m))
