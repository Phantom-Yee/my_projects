...
(cl:defmethod cl:initialize-instance :after ((m <TofsenseFrame0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TofsenseFrame0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<TofsenseFrame0> is deprecated: use custom_msgs-msg:TofsenseFrame0 instead.")))
...
(cl:defmethod dis-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:dis-val is deprecated.  Use custom_msgs-msg:dis instead.")
  (dis m))

(cl:ensure-generic-function 'dis_status-val :lambda-list '(m))
(cl:defmethod dis_status-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:dis_status-val is deprecated.  Use custom_msgs-msg:dis_status instead.")
  (dis_status m))

(cl:ensure-generic-function 'signal_strength-val :lambda-list '(m))
(cl:defmethod signal_strength-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:signal_strength-val is deprecated.  Use custom_msgs-msg:signal_strength instead.")
  (signal_strength m))
