...
"""autogenerated by genpy from custom_msgs/LinktrackNodeframe1.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe1(genpy.Message):
  ...
  _type = "custom_msgs/LinktrackNodeframe1"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','custom_msgs/LinktrackNode1[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = custom_msgs.msg.LinktrackNode1()
        _x = val1
        start = end
        end += 2
