...
"""autogenerated by genpy from custom_msgs/TofsenseCascade.msg. Do not edit."""
import codecs
import sys
...
class TofsenseCascade(genpy.Message):
  ...
  _type = "custom_msgs/TofsenseCascade"
...
"""
  __slots__ = ['nodes']
  _slot_types = ['custom_msgs/TofsenseFrame0[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = custom_msgs.msg.TofsenseFrame0()
        _x = val1
        start = end
        end += 12
